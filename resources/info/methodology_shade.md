...
In addition, hiWalk includes four optional indicators, which you can unselect to avoid slow computations:
...
4. **Shade**: Shaded proportion of each walkable path (in %) based on the presence of canopy cover of trees higher than 2 meters.
