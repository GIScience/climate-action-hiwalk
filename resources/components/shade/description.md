The shade indicator scores each path based on what percentage of the path is covered by trees.
Shaded paths promote walking by reducing the solar radiation and perceived temperature experienced by pedestrians.
