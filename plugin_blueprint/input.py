...
class BlueprintComputeInput(BaseModel):
    ...
    blueprint_bool: bool = Field(title='Boolean Input',
                                 description="A required boolean parameter.",
                                 examples=[True])

    blueprint_int: Optional[int] = Field(title='Integer Input',
    ...
    blueprint_float: Optional[float] = Field(title='Float Input',
    ...
    blueprint_string: Optional[str] = Field(title='String Input',
    ...
    blueprint_select_multi: Optional[List[Option]] = Field(title='Multi-Selection Input',
    ...
    blueprint_aoi: geojson_pydantic.Feature[
    ...
    def get_geom(self) -> shapely.MultiPolygon:
        ...
        """
        return shapely.geometry.shape(self.blueprint_aoi.geometry)
