...
def test_check_contains_cell(default_aoi):
    h3_cell_in_default_aoi = '8a1f8d2f492ffff'
    h3_cell_not_in_default_aoi = '8a1faad6992ffff'

    assert check_contains_cell(aoi=default_aoi, cell_id=h3_cell_in_default_aoi)
    assert not check_contains_cell(aoi=default_aoi, cell_id=h3_cell_not_in_default_aoi)
